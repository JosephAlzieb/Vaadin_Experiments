...
import com.example.application.views.www.WwwView;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(WwwView.class)) {
            nav.addItem(new SideNavItem("www", WwwView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
